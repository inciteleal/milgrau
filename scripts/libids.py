...
# Comand line argument. Use current folder if not provided
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("LIBIDS")
    parser.add_argument("directory", help="Data directory.",  nargs='?', type=is_valid_dir_path)
